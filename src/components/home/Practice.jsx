  ...
  return (
    <div className="flex w-full bg-gradient-to-r from-swim-blue-100 to-swim-blue-300 md:text-2xl 2xl:text-3xl relative mb-[8%]">
      ...
      <div className="w-1/2 pt-[8%] px-[6%] text-white">
        ...
        <div className="flex justify-between md:text-xl 2xl:text-xl mb-5 md:w-full">
          <p>Tuesday and Thursday </p>
          <p className=" text-swim-yellow font-bold ">7:00 pm - 8:20 pm</p>
        </div>

        <div className="flex justify-between md:text-xl 2xl:text-xl mb-8 md:w-full">
          <p>Sunday </p>
